...
void main() {
  testWidgets(
    'Telecaller dashboard screen renders all metric cards and badges correctly',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        ScreenUtilInit(
          designSize: const Size(428, 926),
          builder: (context, child) =>
              const MaterialApp(home: TelecallerDashboardScreen()),
        ),
      );
      ...
      expect(
        find.text('Today'),
        findsNWidgets(3),
      ); // New Leads ("Today"), Today's Followups ("Today"), and Daily Calling Trend ("Today")
      ...
      expect(
        find.text('05'),
        findsNWidgets(4),
      ); // Total Assigned (05), Missed Followups (05), Interested Leads (05), and one more somewhere else.
      expect(find.text('00'), findsNWidgets(16)); // Remaining cards have '00'
    },
  );

  testWidgets('Telecaller dashboard screen renders Site Visits section', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      ScreenUtilInit(
